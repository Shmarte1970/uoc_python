...
'promedio: {value}' y 'Standard deviation: {value}', dichos resultados deben
...
'promedio: {value}' i 'Standard deviation: {value}', aquests resultats deuen
...
def results(list_numbers):
    ...
    desviacion_std = np.std(list_numbers)
