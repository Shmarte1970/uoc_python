                ...
                "feeds": [
                    {
                        ...
                        "url": "https://barcelona.publicbikesystem.net/customer/gbfs/v2/en/geofencing_zones",
                    },
                    {
                        "name": "gbfs_versions",
                        "url": "https://barcelona.publicbikesystem.net/customer/gbfs/v2/gbfs_versions",
                    },
                    {
                        "name": "vehicle_types",
                        "url": "https://barcelona.publicbikesystem.net/customer/gbfs/v2/en/vehicle_types",
                    },
                    {
                    ...
                    {
                        "name": "system_regions",
                        "url": "https://barcelona.publicbikesystem.net/customer/gbfs/v2/en/system_regions",
                    },
                    {
                        "name": "system_information",
                        "url": "https://barcelona.publicbikesystem.net/customer/gbfs/v2/en/system_information",
                    },
                    {
                        "name": "system_pricing_plans",
                        "url": "https://barcelona.publicbikesystem.net/customer/gbfs/v2/en/system_pricing_plans",
                    },
                ]
            }
        },
...
def test_get_gbfs_feeds_success(mock_get, sample_gbfs_response):
    ...
    mock_get.assert_called_once_with(
        "https://barcelona-sp.publicbikesystem.net/customer/gbfs/v2/gbfs.json"
    )

    # Verificar que el resultado es el esperado
    assert result == sample_gbfs_response, (
        "La función debe devolver los datos JSON de la respuesta"
    )
...
def test_extract_feeds_info_success(sample_gbfs_response):
    ...
    assert result[0]["name"] == "geofencing_zones", (
        "El nombre del primer feed debe ser correcto"
    )
    assert (
        result[0]["url"]
        == "https://barcelona.publicbikesystem.net/customer/gbfs/v2/en/geofencing_zones"
    ), "La URL del primer feed debe ser correcta"
...
def test_extract_feeds_info_invalid_format():
    ...
    # Verificar que el resultado es None
    assert result is None, (
        "La función debe devolver None cuando el formato de datos es inválido"
    )
...
def test_print_feeds_summary(sample_gbfs_response, capsys):
    ...
    assert "Barcelona Bike-Sharing System" in captured.out, (
        "La salida debe contener el título del sistema"
    )
    assert f"Available Feeds: {len(feeds_info)}" in captured.out, (
        "La salida debe indicar el número de feeds disponibles"
    )
    assert "geofencing_zones" in captured.out, (
        "La salida debe contener el nombre del primer feed"
    )
    assert (
        "https://barcelona.publicbikesystem.net/customer/gbfs/v2/en/geofencing_zones"
        in captured.out
    ), "La salida debe contener la URL del primer feed"
